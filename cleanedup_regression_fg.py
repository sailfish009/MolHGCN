...
if __name__ == '__main__':
    ...
    p.add_argument('-ds', type=str, default='lipo', help='the name of dataset')
    p.add_argument('-init_feat', type=bool, default=True, help='init FG features')
    p.add_argument('-fg_cyc', type=bool, default=True, help='cycles included in func_group')
    p.add_argument('-num_neurons', type=list, default=[64,32], help='num_neurons in MLP')
