...
from cleanedup.hypergraphnetwork.Networks import Net3
...
def main(ds: str,
    ...
    config = get_config(ds, init_feat, fg_cyc, fully_connected_fg, num_neurons, input_norm, nef_dp, reg_dp)
    ...
    # setup wandb logger
    group_name = 'data-driven' if fully_connected_fg else 'domain-knowledge-driven'
    run = wandb.init(project='MolHGC-he-ablation-{}'.format(config.train.ds),
                     group=group_name,
...
if __name__ == '__main__':
    ...
    p.add_argument('-fully', type=bool, default=False, help='fully connected fg ablation')
    ...
    main(args.ds, args.init_feat, args.fg_cyc, args.fully,
