...
from molhgcn.utils.hypergraph_utils.func_group_helpers import ATOM_FEATURIZER, BOND_FEATURIZER
from molhgcn.utils.hypergraph_utils.graph_gen import smiles_to_hypergraph
...
def get_regression_dataset(dataset: str,
    ...
    # train_ds = GraphDataset(train_gs, train_labels)
    # val_ds = GraphDataset(val_gs, val_labels)
    # test_ds = GraphDataset(test_gs, test_labels)
...
def get_classification_dataset(dataset: str,
    ...
    # train_ds = GraphDataset(train_gs, train_ls, train_masks)
    # val_ds = GraphDataset(val_gs, val_ls, val_masks)
    # test_ds = GraphDataset(test_gs, test_ls, test_masks)
    # return (train_ds, train_tw), (val_ds, val_tw), (test_ds, test_tw)
